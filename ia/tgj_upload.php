...
$recup_organi = mysqli_query($connect, "SELECT * FROM tgj_docs WHERE tgi_pages_id=3 ORDER BY id DESC LIMIT 1;") or die(mysqli_error($connect));

$recup_saison = mysqli_query($connect, "SELECT * FROM tgj_docs WHERE tgi_pages_id=10 ORDER BY id DESC LIMIT 1;") or die(mysqli_error($connect));

...
// récupérations des images de l'utilisateur connecté dans la table photo avec leurs sections même si il n'y a pas de sections sélectionnées (jointure externe avec LEFT)
    $sqlprofil = "SELECT p.*,c.lintitule
    FROM tgj_photos p
    ...
    $recup_sql = mysqli_query($connect, $sqlprofil) or die(mysqli_error($connect));
...
Club Tempogym Jette
20150914 dev upload-images  @iNani
-->
<html>
    <head>
        <meta charset="UTF-8">
        <title>Tempogym Jette</title>
    ...
    <div id="milieu">
        ...
        <div id="formulaire">
            <form action="index.php" enctype="multipart/form-data" method="POST" name="onposte">
...
?>
        ...
        <div id="lesphotos">
            ...
            while ($ligne = mysqli_fetch_assoc($recup_sql)) {
                ...
                /* echo "<p class='hidden>" . $ligne['ladedsc'] . "<br /><br />"; */
                // affichage des sections
                
                echo "</div>";
                $sections = $ligne['lintitule'];
            }
